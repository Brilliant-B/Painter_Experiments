...
if __name__ == '__main__':
    ...
    dst_dir = os.path.join('models_inference', ckpt_dir,
                           "toy_derain_inference_{}_{}".format(ckpt_file, os.path.basename(prompt).split(".")[0]))
    ...
    img2_path = "toy_datasets/derain/train/input/{}.jpg".format(prompt)
    tgt2_path = "toy_datasets/derain/train/target/{}.jpg".format(prompt)
    ...
    print(datasets)
    img_src_dir = "toy_datasets/derain/test/"
