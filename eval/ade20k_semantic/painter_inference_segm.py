...
if __name__ == '__main__':
    ...
    dst_dir = os.path.join('models_inference', ckpt_dir,
                           "toy_ade20k_semseg_inference_{}_{}_size{}/".format(ckpt_file, prompts[0], input_size))
    ...
    img2_paths = [dataset_dir + "ade20k/images/training/{}.jpg".format(prompt) for prompt in prompts]
    tgt2_paths = [dataset_dir + "ade20k/annotations_with_color/training/{}.png".format(prompt) for prompt in prompts]
