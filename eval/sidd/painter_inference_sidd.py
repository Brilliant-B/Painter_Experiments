...
if __name__ == '__main__':
    ...
    dst_dir = os.path.join('models_inference', ckpt_dir.split('/')[-1],
                           "toy_experiments/sidd_inference_{}_{}".format(ckpt_file, os.path.basename(prompt).split(".")[0]))
    ...
    img_src_dir = "toy_datasets/denoise/val/"
    ...
    img2_path = "toy_datasets/denoise/train/input/{}.png".format(prompt)
    tgt2_path = "toy_datasets/denoise/train/groundtruth/{}.png".format(prompt)
