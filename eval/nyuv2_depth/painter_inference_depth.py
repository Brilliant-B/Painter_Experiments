...
if __name__ == '__main__':
    ...
    img_src_dir = "toy_datasets/nyu_depth_v2/official_splits/test/"
    img_path_list = glob.glob(img_src_dir + "/*/rgb*g")
    img2_path = "toy_datasets/nyu_depth_v2/sync/{}.jpg".format(args.prompt)
    tgt_path = "toy_datasets/nyu_depth_v2/sync/{}.png".format(args.prompt.replace('rgb', 'sync_depth'))
    tgt2_path = tgt_path
