...
if __name__ == '__main__':
    ...
    dst_dir = os.path.join('models_inference', ckpt_dir.split('/')[-1],
                           "toy_experiments/coco_pose_inference_{}_{}".format(ckpt_path, os.path.basename(prompt).split(".")[0]))
    if args.flip_test:
    ...
    img_src_dir = dataset_dir + "coco_pose/data_pair/val_256x192"
    if args.flip_test:
        img_src_dir += "_flip"
